...
void FlightSummaryCalculate()
{
	...
	KissStats.MAXWatt = FlightSummaryMax(KissStats.MAXWatt, ( (KissTelemetrie.current/10)*(uint16_t(KissTelemetrie.LipoVoltage)/100) )  );
