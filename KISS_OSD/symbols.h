...
//Angel indicators
#define ANGEL_CLEAR 0X7F
#define ANGEL_DOWN 0X8A
#define ANGEL_LIGHTDOWN 0X8B
#define ANGEL_MIDDLEDOWN 0X8C
#define ANGEL_MIDDLEUP 0X8D
#define ANGEL_LIGHTUP 0X8E
#define ANGEL_UP 0X8F
