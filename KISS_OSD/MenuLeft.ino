...
void MenuLeft_Valie(bool addsub)
{
	...
	case 1:
		...
		{
		case 1: changeval(addsub, 0, 65000, 50, &KissSettings.PID_P[0]);
			break;
		case 2: changeval(addsub, 0, 65000, 10, &KissSettings.PID_I[0]);
			break;
		case 3: changeval(addsub, 0, 65000, 100, &KissSettings.PID_D[0]);
			break;
		case 4: changeval(addsub, 0, 65000, 50, &KissSettings.PID_P[1]);
			break;
		case 5: changeval(addsub, 0, 65000, 10, &KissSettings.PID_I[1]);
			break;
		case 6: changeval(addsub, 0, 65000, 100, &KissSettings.PID_D[1]);
			break;
		case 7: changeval(addsub, 0, 65000, 50, &KissSettings.PID_P[2]);
			break;
		case 8: changeval(addsub, 0, 65000, 10, &KissSettings.PID_I[2]);
			break;
		case 9: changeval(addsub, 0, 65000, 100, &KissSettings.PID_D[2]);
			break;

		case 10: changeval(addsub, 0, 2000, 10, &KissSettings.RC_Rate[0]);
			break;
		case 11: changeval(addsub, 0, 2000, 10, &KissSettings.Rate[0]);
			break;
		case 12: changeval(addsub, 0, 2000, 10, &KissSettings.RC_Curve[0]);
			break;
		case 13: changeval(addsub, 0, 2000, 10, &KissSettings.RC_Rate[1]);
			break;
		case 14: changeval(addsub, 0, 2000, 10, &KissSettings.Rate[1]);
			break;
		case 15: changeval(addsub, 0, 2000, 10, &KissSettings.RC_Curve[1]);
			break;
		case 16: changeval(addsub, 0, 65000, 100, &KissSettings.RC_Rate[2]);
			break;
		case 17: changeval(addsub, 0, 65000, 100, &KissSettings.Rate[2]);
			break;
		case 18: changeval(addsub, 0, 65000, 100, &KissSettings.RC_Curve[2]);
			break;
		}
		break;
	}
